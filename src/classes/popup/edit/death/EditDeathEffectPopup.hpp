...
protected:
    ...
    geode::Result<> saveEffect(const gd::string& name);
    ...
    void updateWithSelectedFiles(bool update = true);
    geode::Result<> updateWithSelectedFilesInternal(bool update = true);
    void updatePieces();
    void updateState();
    void updateTargets();
